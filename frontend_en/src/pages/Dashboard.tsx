        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-blue-900 mb-1">Trial Mode</h3>
              <p className="text-sm text-blue-700 mb-2">
                You're using OpenNotebookLM in trial mode. Configure Supabase to enable user authentication and multi-user support.
              </p>
              <a
              ...
              >
                Learn how to configure Supabase →
              </a>
            </div>
          </div>
        </motion.div>
